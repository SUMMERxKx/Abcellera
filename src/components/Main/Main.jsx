...
const Main = () => {
  const prompt1 = "Who are AbCellera";
  const prompt2 = "Key Features of AbCellera";
  const prompt3 = "How does AbCellera technology work?";
  const prompt4 = "When was AbCellera formed?";
      ...
      {!showResult ? (
        <>
          <div className="greet">
              ...
              <p>Welcome to AbCellera ChatBot</p>
          </div>
          <div className="cards">
